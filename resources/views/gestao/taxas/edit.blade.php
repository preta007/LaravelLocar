                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="codigo_vindi"  class="form-control {{ $errors->has('codigo_vindi') ? "is-invalid":"" }}"  value="{{ old('codigo_vindi', $taxa->codigo_vindi) }}" step="0.01" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="codigo_plano_vindi"  class="form-control {{ $errors->has('codigo_plano_vindi') ? "is-invalid":"" }}"  value="{{ old('codigo_plano_vindi', $taxa->codigo_plano_vindi) }}" step="0.01" required>
