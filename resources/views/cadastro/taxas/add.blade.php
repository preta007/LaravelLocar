                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('taxaCreate') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="valor"  class="form-control valor {{ $errors->has('valor') ? "is-invalid":"" }}" value="{{ old('valor') }}" step="0.01" required>
                                @if($errors->has('valor'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="comissao"  class="form-control valor {{ $errors->has('comissao') ? "is-invalid":"" }}"  value="{{ old('comissao') }}" step="0.01" required>
