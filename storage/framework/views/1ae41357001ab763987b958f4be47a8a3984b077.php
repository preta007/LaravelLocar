                                ...
                                <?php $__currentLoopData = $taxas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <i style="cursor: pointer" id="taxa_<?php echo e($taxa->id); ?>" class="fas <?php echo e($plano->ativo ? "fa-check-circle text-success":"fa-times-circle text-danger"); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-8-RBAC-AdminLte3\resources\views/pages/taxas/index.blade.php ENDPATH**/ ?>