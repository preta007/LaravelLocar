...
<body class="<?php echo e(auth()->user()->theme()['body'] ?? ''); ?> hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
<div class="wrapper" style="display: block">

	<!-- Navbar-->
	<nav class="main-header navbar navbar-expand <?php echo e(auth()->user()->theme()['navbar'] ?? 'navbar-light'); ?>">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown">
				...
				<img src="<?php echo e(asset('consImages/logoU.png')); ?>" alt="Product 1" class="img-circle img-size-50 mr-3">
			</li>
		</ul>
	...
	<aside class="main-sidebar elevation-1 <?php echo e(auth()->user()->theme()['sidebar'] ?? 'sidebar-dark-primary'); ?>">
		<!-- Brand Logo -->
		<a href="#" class="brand-link">
			<img src="<?php echo e(asset('consImages/'.auth()->user()->theme()['logo'])); ?>" alt="LocarMais" class="brand-image">
		</a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="https://locarmais.com">LocarMais </a>.</strong>
        All rights reserved.
...
<?php /**PATH C:\xampp\htdocs\LocarMaisNovo\resources\views/layouts/admin.blade.php ENDPATH**/ ?>