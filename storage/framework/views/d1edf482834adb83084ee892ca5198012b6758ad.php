            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('api-userUpdate',$user->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="token_valid_period" max="180" min="1" class="form-control <?php echo e($errors->has('token_valid_period') ? "is-invalid":""); ?>" value="<?php echo e(old('token_valid_period',$user->token_valid_period)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LocarMaisNovo\resources\views/pages/api-user/edit.blade.php ENDPATH**/ ?>