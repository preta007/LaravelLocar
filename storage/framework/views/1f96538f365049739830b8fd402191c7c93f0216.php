...
<nav class="mt-2">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any('manage.show')): ?>
            <li class="nav-item has-treeview">
                <a href="#" class="nav-link <?php echo e((Request::is('plano*')) ? 'active':''); ?>">
...
<?php /**PATH C:\xampp\htdocs\Laravel-8-RBAC-AdminLte3\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>