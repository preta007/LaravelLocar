                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('permissionUpdate',$permission->id)); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control <?php echo e($errors->has('name') ? "is-invalid":""); ?>" value="<?php echo e(old('name',$permission->name)); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" value="<?php echo e(old('title',$permission->title)); ?>">
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel-8-RBAC-AdminLte3\resources\views/pages/permissions/edit.blade.php ENDPATH**/ ?>