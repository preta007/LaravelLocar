            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('api-userIndex')); ?>"><?php echo app('translator')->get('cruds.taxa.title'); ?></a></li>
            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('taxaUpdate',$taxa->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label><?php echo app('translator')->get('cruds.taxa.fields.name'); ?></label>
                                <input type="text" name="nome" class="form-control <?php echo e($errors->has('nome') ? "is-invalid":""); ?>" value="<?php echo e(old('nome', $taxa->nome)); ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="valor"  class="form-control <?php echo e($errors->has('valor') ? "is-invalid":""); ?>" value="<?php echo e(old('valor', $taxa->valor)); ?>" step="0.01" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="comissao"  class="form-control <?php echo e($errors->has('comissao') ? "is-invalid":""); ?>" value="<?php echo e(old('comissao', $taxa->comissao)); ?>" step="0.01" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="codigo_vindi"  class="form-control <?php echo e($errors->has('codigo_vindi') ? "is-invalid":""); ?>"  value="<?php echo e(old('codigo_vindi', $taxa->codigo_vindi)); ?>" step="0.01" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="codigo_plano_vindi"  class="form-control <?php echo e($errors->has('codigo_plano_vindi') ? "is-invalid":""); ?>"  value="<?php echo e(old('codigo_plano_vindi', $taxa->codigo_plano_vindi)); ?>" step="0.01" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="parcelas"  class="form-control <?php echo e($errors->has('parcelas') ? "is-invalid":""); ?>" value="<?php echo e(old('parcelas', $taxa->parcelas)); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LocarMaisNovo\resources\views/gestao/taxas/edit.blade.php ENDPATH**/ ?>